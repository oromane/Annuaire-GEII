<?php
// documents-detail.php - contenu détaillé pour chaque thème
$topic = $_GET['t'] ?? 'cv';
...
<ul>
  ...
  <li>Conception armoire <strong>CEI 60204-1</strong>, schémas <strong>SEE Electrical</strong>.</li>
    ...
    'see' => [
      ['t' => 'Lettre de motivation', 'href' => '/Annuaire/pages/documents-detail.php?t=lettre'],
      ['t' => 'Mail professionnel', 'href' => '/Annuaire/pages/documents-detail.php?t=mail'],
      ['t' => 'Documents utiles', 'href' => '/Annuaire/pages/documents-detail.php?t=docs'],
    ],
  ],
...
<ul>
  ...
  <li>Signature complète + PJ nommées.</li>
    ...
    'see' => [
      ['t' => 'Créer un CV', 'href' => '/Annuaire/pages/documents-detail.php?t=cv'],
      ['t' => 'Mail professionnel', 'href' => '/Annuaire/pages/documents-detail.php?t=mail'],
      ['t' => 'Documents utiles', 'href' => '/Annuaire/pages/documents-detail.php?t=docs'],
    ],
  ],
...
<ul>
  ...
  <li>Suivi à J+5 si pas de nouvelles.</li>
    ...
    'see' => [
      ['t' => 'Techniques d’argumentation', 'href' => '/Annuaire/pages/documents-detail.php?t=argumentation'],
      ['t' => 'Documents utiles', 'href' => '/Annuaire/pages/documents-detail.php?t=docs'],
    ],
  ],
...
<ul>
  <li>Reformuler, donner un exemple mesuré, proposer une alternative.</li>
    ...
    'see' => [
      ['t' => 'Entretien', 'href' => '/Annuaire/pages/documents-detail.php?t=entretien'],
      ['t' => 'Documents utiles', 'href' => '/Annuaire/pages/documents-detail.php?t=docs'],
    ],
  ],
  ...
  'docs' => [
    ...
    'sections' => [
      [
        ...
        'p' => '
  <ul class="doc-list">
    <li><a href="/Annuaire/docs/CREER_CV_VIDEO.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Créer un CV vidéo</a></li>
    <li><a href="/Annuaire/docs/COURS_ENTRETIEN_MOTIVATION.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Cours : entretien & motivation</a></li>
    <li><a href="/Annuaire/docs/REGLES_LM.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Règles de la lettre de motivation</a></li>
    <li><a href="/Annuaire/docs/MAIL_PROFESSIONNEL.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Mail professionnel</a></li>
    <li><a href="/Annuaire/docs/DOC1_OBJECTIFS_ALTERNANCE_STAGE.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Objectifs Stage / Alternance</a></li>
    <li><a href="/Annuaire/docs/doc_etudiant_preparation_entretien.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Préparation entretien (étudiant)</a></li>
    <li><a href="/Annuaire/docs/TECHNIQUES_ARGUMENTATION.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Techniques d’argumentation</a></li>
    <li><a href="/Annuaire/docs/sitographie_cvlm.pdf" target="_blank" rel="noopener"><span class="ico">📄</span> Sitographie CV/LM</a></li>
  </ul>'
      ],
    ],
    'see' => [
      ...
      ['t' => 'Lettre de motivation', 'href' => '/Annuaire/pages/documents-detail.php?t=lettre'],
      ['t' => 'Mail professionnel', 'href' => '/Annuaire/pages/documents-detail.php?t=mail'],
      ['t' => 'Préparer l’entretien', 'href' => '/Annuaire/pages/documents-detail.php?t=entretien'],
    ],
  ],
...
<ul>
  ...
  <li>Voir aussi la <a href="documents-detail.php?t=docs">page Documents utiles</a>.</li>
</ul>'
      ],
    ],
  ],
...
<body>
  <?php
  $page_title = $cur['title'] . ' · Documents GEII';
  $page_description = 'Document détaillé : ' . $cur['intro'];
  ...
  <main class="main-detail-aide">
    <nav class="aide-detail-nav">
      <a class="btn outline" href="documents.php">← Retour aux documents</a>
    </nav>
